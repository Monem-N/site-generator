...
const main = () => {
  ...
  console.log('\nTo fix these issues:');
  console.log('1. For no-fallthrough: Add break statements or // fallthrough comments in switch cases');
  console.log('2. For no-console: Replace console.log with a logger or remove debugging statements');
