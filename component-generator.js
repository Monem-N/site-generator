...
class ComponentGenerator {
  ...
  applyDesignSystem(componentCode, elementType) {
    ...
    const dsConfig =
      (_b = (_a = this.designSystem).getConfigForType) === null || _b === void 0
        ? void 0
        : _b.call(_a, elementType);
    // Replace placeholder classes with design system classes
    let styledCode = componentCode;
    for (const [placeholder, actualClass] of Object.entries(
      (dsConfig === null || dsConfig === void 0 ? void 0 : dsConfig.classMapping) || {}
    )) {
      styledCode = styledCode.replace(new RegExp(`{${placeholder}}`, 'g'), actualClass);
    }
    // Add design system imports if needed
    const imports = this.generateImports(
      (dsConfig === null || dsConfig === void 0 ? void 0 : dsConfig.components) || []
    );
    return `${imports}\n\n${styledCode}`;
  }
...
export default function ${this.sanitizeComponentName(pageTitle)}() {
  return (
    <div className={${
      ((_b = (_a = this.designSystem) === null || _a === void 0 ? void 0 : _a.classNames) ===
        null || _b === void 0
        ? void 0
        : _b.pageContainer) || ''
    }}>
...
`;
  ...
  generatePageImports() {
    ...
    const dsImports = `import { ${
      (_b = (_a = this.designSystem) === null || _a === void 0 ? void 0 : _a.pageComponents) ===
        null || _b === void 0
        ? void 0
        : _b.join(', ')
    } } from '${this.designSystem.importPath}';`;
    return `${baseImports}\n${dsImports}`;
  }
...
class SectionTemplate {
  async generate(element, designSystem) {
    ...
    const dsConfig =
      (_a =
        designSystem === null || designSystem === void 0
          ? void 0
          : designSystem.getConfigForType) === null || _a === void 0
        ? void 0
        : _a.call(designSystem, 'section');
    // Determine heading level
    const HeadingTag = `h${level}`;
    return `
<section className="${
      ((_b = dsConfig === null || dsConfig === void 0 ? void 0 : dsConfig.classMapping) === null ||
      _b === void 0
        ? void 0
        : _b.sectionContainer) || ''
    }">
  <${HeadingTag} className="${
      ((_c = dsConfig === null || dsConfig === void 0 ? void 0 : dsConfig.classMapping) === null ||
      _c === void 0
        ? void 0
        : _c[`heading${level}`]) || ''
    }">${title}</${HeadingTag}>
  <div className="${
    ((_d = dsConfig === null || dsConfig === void 0 ? void 0 : dsConfig.classMapping) === null ||
    _d === void 0
      ? void 0
      : _d.contentContainer) || ''
  }">
    ...
    return content
      .map(item => {
        ...
        if (item.type === 'paragraph') {
          return `<p className="${
            ((_a = dsConfig === null || dsConfig === void 0 ? void 0 : dsConfig.classMapping) ===
              null || _a === void 0
              ? void 0
              : _a.paragraph) || ''
          }">${item.content.join(' ')}</p>`;
    ...
    const dsConfig =
      (_a =
        designSystem === null || designSystem === void 0
          ...
          : designSystem.getConfigForType) === null || _a === void 0
        ? void 0
        : _a.call(designSystem, 'api-endpoint');
    return `
<div className="${
      ((_b = dsConfig === null || dsConfig === void 0 ? void 0 : dsConfig.classMapping) === null ||
      _b === void 0
        ? void 0
        : _b.apiEndpointContainer) || ''
    }">
  <div className="${
    ((_c = dsConfig === null || dsConfig === void 0 ? void 0 : dsConfig.classMapping) === null ||
    _c === void 0
      ...
      _d === void 0
        ? void 0
        : _d[`method${method.toLowerCase()}`]) || ''
    }">
    <span className="${
      ((_e = dsConfig === null || dsConfig === void 0 ? void 0 : dsConfig.classMapping) === null ||
      _e === void 0
        ? void 0
        : _e.httpMethod) || ''
    }">${method}</span>
    <span className="${
      ((_f = dsConfig === null || dsConfig === void 0 ? void 0 : dsConfig.classMapping) === null ||
      _f === void 0
        ? void 0
        : _f.endpointPath) || ''
    }">${endpoint}</span>
  ...
  <div className="${
    ((_g = dsConfig === null || dsConfig === void 0 ? void 0 : dsConfig.classMapping) === null ||
    _g === void 0
      ? void 0
      : _g.endpointBody) || ''
  }">
...
`;
  ...
  renderParameters(parameters, designSystem) {
    ...
    <div className="${
      ...
      _b === void 0
        ? void 0
        : _b.parametersSection) || ''
    }">
      <h4 className="${
        ((_c = dsConfig === null || dsConfig === void 0 ? void 0 : dsConfig.classMapping) ===
          null || _c === void 0
          ? void 0
          : _c.sectionTitle) || ''
      }">Parameters</h4>
      <table className="${
        ((_d = dsConfig === null || dsConfig === void 0 ? void 0 : dsConfig.classMapping) ===
          null || _d === void 0
          ? void 0
          : _d.parametersTable) || ''
      }">
    ...
    const dsConfig =
      (_a =
        designSystem === null || designSystem === void 0
          ...
          : designSystem.getConfigForType) === null || _a === void 0
        ? void 0
        : _a.call(designSystem, 'navigation');
    return `
<nav className="${
      ((_b = dsConfig === null || dsConfig === void 0 ? void 0 : dsConfig.classMapping) === null ||
      _b === void 0
        ? void 0
        : _b.navigationContainer) || ''
    }">
  <ul className="${
    ((_c = dsConfig === null || dsConfig === void 0 ? void 0 : dsConfig.classMapping) === null ||
    _c === void 0
    ...
    ${items
      .map(item => {
        ...
        return `
    <li className="${
      ((_a = dsConfig === null || dsConfig === void 0 ? void 0 : dsConfig.classMapping) === null ||
      _a === void 0
        ? void 0
        : _a.navItem) || ''
    }">
      <a href="${item.path}" className="${
          ((_b = dsConfig === null || dsConfig === void 0 ? void 0 : dsConfig.classMapping) ===
            null || _b === void 0
            ? void 0
            : _b.navLink) || ''
        }${
